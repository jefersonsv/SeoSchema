...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/DrugCost"/>
    /// </summary>
    public class DrugCost : IEntity
    {
        /// The location in which the status applies.
        public Or<AdministrativeArea>? ApplicableLocation { get; set; }

        /// The category of cost, such as wholesale, retail, reimbursement cap, etc.
        public Or<DrugCostCategory>? CostCategory { get; set; }

        /// The currency (in 3-letter of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217
        public Or<string>? CostCurrency { get; set; }

        /// Additional details to capture the origin of the cost data. For example, 'Medicare Part B'.
        public Or<string>? CostOrigin { get; set; }

        /// The cost per unit of the drug.
        public Or<double, QualitativeValue, string>? CostPerUnit { get; set; }
