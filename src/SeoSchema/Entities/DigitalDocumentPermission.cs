...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/DigitalDocumentPermission"/>
    /// </summary>
    public class DigitalDocumentPermission : IEntity
    {
        /// The person, organization, contact point, or audience that has been granted this permission.
        public Or<Audience, ContactPoint, Organization, Person>? Grantee { get; set; }

        /// The type of permission granted the person, organization, or audience.
        public Or<DigitalDocumentPermissionType>? PermissionType { get; set; }
