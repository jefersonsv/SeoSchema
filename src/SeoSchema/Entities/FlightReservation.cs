...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/FlightReservation"/>
    /// </summary>
    public class FlightReservation : IEntity
    {
        /// The airline-specific indicator of boarding order / preference.
        public Or<string>? BoardingGroup { get; set; }

        /// The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
        public Or<QualitativeValue, string>? PassengerPriorityStatus { get; set; }

        /// The passenger's sequence number as assigned by the airline.
        public Or<string>? PassengerSequenceNumber { get; set; }

        /// The type of security screening the passenger is subject to.
        public Or<string>? SecurityScreening { get; set; }
