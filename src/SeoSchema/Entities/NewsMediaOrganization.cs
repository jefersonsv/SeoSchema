...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/NewsMediaOrganization"/>
    /// </summary>
    public class NewsMediaOrganization : IEntity
    {
        ...
        public Or<CreativeWork, Uri>? Masthead { get; set; }

        /// For a NewsMediaOrganization, a statement on coverage priorities, including any public agenda or stance on issues.
        public Or<CreativeWork, Uri>? MissionCoveragePrioritiesPolicy { get; set; }

        /// For a NewsMediaOrganization or other news-related Organization, a statement explaining when authors of articles are not named in bylines.
        public Or<CreativeWork, Uri>? NoBylinesPolicy { get; set; }
        ...
        public Or<CreativeWork, Uri>? VerificationFactCheckingPolicy { get; set; }
