...
namespace SeoSchema.Entities
{
    /// <summary>
    /// An image file.
    /// <see cref="https://schema.org/ImageObject"/>
    /// </summary>
    public class ImageObject : IEntity
    {
        /// The caption for this object.
        public Or<string>? Caption { get; set; }

        /// exif data for this object.
        public Or<PropertyValue, string>? ExifData { get; set; }

        /// Indicates whether this image is representative of the content of the page.
        public Or<bool>? RepresentativeOfPage { get; set; }
