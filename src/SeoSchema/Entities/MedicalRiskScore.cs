...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MedicalRiskScore"/>
    /// </summary>
    public class MedicalRiskScore : IEntity
    {
        /// The algorithm or rules to follow to compute the score.
        public Or<string>? Algorithm { get; set; }

        /// The condition, complication, or symptom whose risk is being estimated.
        public Or<MedicalEntity>? EstimatesRiskOf { get; set; }

        /// A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
        public Or<MedicalRiskFactor>? IncludedRiskFactor { get; set; }
