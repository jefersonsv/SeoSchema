...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/Muscle"/>
    /// </summary>
    public class Muscle : IEntity
    {
        /// Obsolete term for muscleAction. Not to be confused with potentialAction.
        public Or<string>? Action { get; set; }

        /// The muscle whose action counteracts the specified muscle.
        public Or<Muscle>? Antagonist { get; set; }

        /// The blood vessel that carries blood from the heart to the muscle.
        public Or<Vessel>? BloodSupply { get; set; }

        /// The place of attachment of a muscle, or what the muscle moves.
        public Or<AnatomicalStructure>? Insertion { get; set; }

        /// The movement the muscle generates.
        public Or<string>? MuscleAction { get; set; }

        /// The underlying innervation associated with the muscle.
        public Or<Nerve>? Nerve { get; set; }

        /// The place or point where a muscle arises.
        public Or<AnatomicalStructure>? Origin { get; set; }
