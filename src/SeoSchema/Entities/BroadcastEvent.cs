...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/BroadcastEvent"/>
    /// </summary>
    public class BroadcastEvent : IEntity
    {
        /// The event being broadcast such as a sporting event or awards ceremony.
        public Or<Event>? BroadcastOfEvent { get; set; }

        /// True is the broadcast is of a live event.
        public Or<bool>? IsLiveBroadcast { get; set; }

        /// The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).
        public Or<string>? VideoFormat { get; set; }

        /// A flag to signal that the item, event, or place is accessible for free. Supersedes free.
        public Or<bool>? IsAccessibleForFree { get; set; }

        /// An agent associated with the publication event.
        public Or<Organization, Person>? PublishedBy { get; set; }

        /// A broadcast service associated with the publication event.
        public Or<BroadcastService>? PublishedOn { get; set; }
