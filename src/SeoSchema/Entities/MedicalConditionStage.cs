...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MedicalConditionStage"/>
    /// </summary>
    public class MedicalConditionStage : IEntity
    {
        /// The stage represented as a number, e.g. 3.
        public Or<double>? StageAsNumber { get; set; }

        /// The substage, e.g. 'a' for Stage IIIa.
        public Or<string>? SubStageSuffix { get; set; }
