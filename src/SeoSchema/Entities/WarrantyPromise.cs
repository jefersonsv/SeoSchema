...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/WarrantyPromise"/>
    /// </summary>
    public class WarrantyPromise : IEntity
    {
        /// The duration of the warranty promise. Common unitCode values are ANN for year, MON for months, or DAY for days.
        public Or<QuantitativeValue>? DurationOfWarranty { get; set; }

        /// The scope of the warranty promise.
        public Or<WarrantyScope>? WarrantyScope { get; set; }
