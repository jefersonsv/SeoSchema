...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MedicalCode"/>
    /// </summary>
    public class MedicalCode : IEntity
    {
        /// A short textual code that uniquely identifies the value.
        public Or<string>? CodeValue { get; set; }

        /// The coding system, e.g. 'ICD-10'.
        public Or<string>? CodingSystem { get; set; }
        ...
        public Or<CategoryCodeSet, Uri>? InCodeSet { get; set; }

        /// A DefinedTermSet that contains this term.
        public Or<DefinedTermSet, Uri>? InDefinedTermSet { get; set; }

        /// A code that identifies this DefinedTerm within a DefinedTermSet
        public Or<string>? TermCode { get; set; }
