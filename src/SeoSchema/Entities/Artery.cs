...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/Artery"/>
    /// </summary>
    public class Artery : IEntity
    {
        /// The branches that comprise the arterial structure. Supersedes branch.
        public Or<AnatomicalStructure>? ArterialBranch { get; set; }

        /// The anatomical or organ system that the artery originates from.
        public Or<AnatomicalStructure>? Source { get; set; }

        /// The area to which the artery supplies blood.
        public Or<AnatomicalStructure>? SupplyTo { get; set; }
