...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/ExchangeRateSpecification"/>
    /// </summary>
    public class ExchangeRateSpecification : IEntity
    {
        ...
        public Or<UnitPriceSpecification>? CurrentExchangeRate { get; set; }

        /// The difference between the price at which a broker or other intermediary buys and sells foreign currency.
        public Or<MonetaryAmount, double>? ExchangeRateSpread { get; set; }
