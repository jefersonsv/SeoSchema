...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MusicAlbum"/>
    /// </summary>
    public class MusicAlbum : IEntity
    {
        /// Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
        public Or<MusicAlbumProductionType>? AlbumProductionType { get; set; }

        /// A release of this album. Inverse property: releaseOf.
        public Or<MusicRelease>? AlbumRelease { get; set; }

        /// The kind of release which this album is: single, EP or album.
        public Or<MusicAlbumReleaseType>? AlbumReleaseType { get; set; }

        /// The artist that performed this album or recording.
        public Or<MusicGroup>? ByArtist { get; set; }
