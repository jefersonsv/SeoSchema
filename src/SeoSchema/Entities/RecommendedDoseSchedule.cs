...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/RecommendedDoseSchedule"/>
    /// </summary>
    public class RecommendedDoseSchedule : IEntity
    {
        /// The unit of the dose, e.g. 'mg'.
        public Or<string>? DoseUnit { get; set; }

        /// The value of the dose, e.g. 500.
        public Or<double, QualitativeValue>? DoseValue { get; set; }

        /// How often the dose is taken, e.g. 'daily'.
        public Or<string>? Frequency { get; set; }
