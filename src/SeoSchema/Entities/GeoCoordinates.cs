...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/GeoCoordinates"/>
    /// </summary>
    public class GeoCoordinates : IEntity
    {
        ...
        public Or<double, string>? Latitude { get; set; }

        /// The longitude of a location. For example -122.08585 (WGS 84).
        public Or<double, string>? Longitude { get; set; }
