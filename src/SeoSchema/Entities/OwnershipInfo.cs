...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/OwnershipInfo"/>
    /// </summary>
    public class OwnershipInfo : IEntity
    {
        /// The organization or person from which the product was acquired.
        public Or<Organization, Person>? AcquiredFrom { get; set; }

        /// The date and time of obtaining the product.
        public Or<DateTime>? OwnedFrom { get; set; }

        /// The date and time of giving up ownership on the product.
        public Or<DateTime>? OwnedThrough { get; set; }

        /// The product that this structured value is referring to.
        public Or<Product, Service>? TypeOfGood { get; set; }
