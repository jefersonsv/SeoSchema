...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/ProgramMembership"/>
    /// </summary>
    public class ProgramMembership : IEntity
    {
        /// The organization (airline, travelers' club, etc.) the membership is made with.
        public Or<Organization>? HostingOrganization { get; set; }
        ...
        public Or<string>? MembershipNumber { get; set; }

        /// The program providing the membership.
        public Or<string>? ProgramName { get; set; }
