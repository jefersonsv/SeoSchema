...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/LodgingReservation"/>
    /// </summary>
    public class LodgingReservation : IEntity
    {
        /// The earliest someone may check into a lodging establishment.
        public Or<DateTime>? CheckinTime { get; set; }

        /// The latest someone may check out of a lodging establishment.
        public Or<DateTime>? CheckoutTime { get; set; }

        /// A full description of the lodging unit.
        public Or<string>? LodgingUnitDescription { get; set; }

        /// Textual description of the unit type (including suite vs. room, size of bed, etc.).
        public Or<QualitativeValue, string>? LodgingUnitType { get; set; }

        /// The number of adults staying in the unit.
        public Or<int, QuantitativeValue>? NumAdults { get; set; }

        /// The number of children staying in the unit.
        public Or<int, QuantitativeValue>? NumChildren { get; set; }
