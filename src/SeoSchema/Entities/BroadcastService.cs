...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/BroadcastService"/>
    /// </summary>
    public class BroadcastService : IEntity
    {
        /// The media network(s) whose content is broadcast on this station.
        public Or<Organization>? BroadcastAffiliateOf { get; set; }

        /// The name displayed in the channel guide. For many US affiliates, it is the network name.
        public Or<string>? BroadcastDisplayName { get; set; }
        ...
        public Or<string>? BroadcastTimezone { get; set; }

        /// The organization owning or operating the broadcast service.
        public Or<Organization>? Broadcaster { get; set; }

        /// A broadcast channel of a broadcast service. Inverse property: providesBroadcastService.
        public Or<BroadcastChannel>? HasBroadcastChannel { get; set; }

        /// A broadcast service to which the broadcast service may belong to such as regional variations of a national channel.
        public Or<BroadcastService>? ParentService { get; set; }
