...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/TelevisionChannel"/>
    /// </summary>
    public class TelevisionChannel : IEntity
    {
        /// The unique address by which the BroadcastService can be identified in a provider lineup. In US, this is typically a number.
        public Or<string>? BroadcastChannelId { get; set; }

        /// The frequency used for over-the-air broadcasts. Numeric values or simple ranges e.g. 87-99. In addition a shortcut idiom is supported for frequences of AM and FM radio channels, e.g. "87 FM".
        public Or<BroadcastFrequencySpecification, string>? BroadcastFrequency { get; set; }

        /// The type of service required to have access to the channel (e.g. Standard or Premium).
        public Or<string>? BroadcastServiceTier { get; set; }

        /// Genre of the creative work, broadcast channel or group.
        public Or<string, Uri>? Genre { get; set; }

        /// The CableOrSatelliteService offering the channel.
        public Or<CableOrSatelliteService>? InBroadcastLineup { get; set; }

        /// The BroadcastService offered on this channel. Inverse property: hasBroadcastChannel.
        public Or<BroadcastService>? ProvidesBroadcastService { get; set; }
