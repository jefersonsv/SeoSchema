...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/RentalCarReservation"/>
    /// </summary>
    public class RentalCarReservation : IEntity
    {
        /// Where a rental car can be dropped off.
        public Or<Place>? DropoffLocation { get; set; }

        /// When a rental car can be dropped off.
        public Or<DateTime>? DropoffTime { get; set; }

        /// Where a taxi will pick up a passenger or a rental car can be picked up.
        public Or<Place>? PickupLocation { get; set; }

        /// When a taxi will pickup a passenger or a rental car can be picked up.
        public Or<DateTime>? PickupTime { get; set; }
