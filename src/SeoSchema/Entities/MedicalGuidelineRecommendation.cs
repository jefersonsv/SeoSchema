...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MedicalGuidelineRecommendation"/>
    /// </summary>
    public class MedicalGuidelineRecommendation : IEntity
    {
        /// Strength of the guideline's recommendation (e.g. 'class I').
        public Or<string>? RecommendationStrength { get; set; }
