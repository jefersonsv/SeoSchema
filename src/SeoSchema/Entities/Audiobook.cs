...
namespace SeoSchema.Entities
{
    /// <summary>
    /// An audiobook.
    /// <see cref="https://schema.org/Audiobook"/>
    /// </summary>
    public class Audiobook : IEntity
    {
        /// The duration of the item (movie, audio recording, event, etc.) in ISO 8601 date format.
        public Or<Duration>? Duration { get; set; }

        /// A person who reads (performs) the audiobook.
        public Or<Person>? ReadBy { get; set; }

        /// If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
        public Or<string>? Transcript { get; set; }
        ...
        public Or<bool>? Abridged { get; set; }

        /// The edition of the book.
        public Or<string>? BookEdition { get; set; }

        /// The format of the book.
        public Or<BookFormatType>? BookFormat { get; set; }

        /// The illustrator of the book.
        public Or<Person>? Illustrator { get; set; }

        /// The ISBN of the book.
        public Or<string>? Isbn { get; set; }

        /// The number of pages in the book.
        public Or<int>? NumberOfPages { get; set; }
