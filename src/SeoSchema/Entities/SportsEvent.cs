...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/SportsEvent"/>
    /// </summary>
    public class SportsEvent : IEntity
    {
        /// The away team in a sports event.
        public Or<Person, SportsTeam>? AwayTeam { get; set; }

        /// A competitor in a sports event.
        public Or<Person, SportsTeam>? Competitor { get; set; }

        /// The home team in a sports event.
        public Or<Person, SportsTeam>? HomeTeam { get; set; }
