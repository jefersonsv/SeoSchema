...
namespace SeoSchema.Entities
{
    /// <summary>
    /// A video game series.
    /// <see cref="https://schema.org/VideoGameSeries"/>
    /// </summary>
    public class VideoGameSeries : IEntity
    {
        ...
        public Or<CreativeWorkSeason>? ContainsSeason { get; set; }
        ...
        public Or<Episode>? Episode { get; set; }
        ...
        public Or<int>? NumberOfEpisodes { get; set; }

        /// Indicate how many people can play this game (minimum, maximum, or range).
        public Or<QuantitativeValue>? NumberOfPlayers { get; set; }

        /// The number of seasons in this series.
        public Or<int>? NumberOfSeasons { get; set; }
