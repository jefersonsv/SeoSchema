...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/GovernmentPermit"/>
    /// </summary>
    public class GovernmentPermit : IEntity
    {
        /// The organization issuing the ticket or permit.
        public Or<Organization>? IssuedBy { get; set; }

        /// The service through with the permit was granted.
        public Or<Service>? IssuedThrough { get; set; }

        /// The target audience for this permit.
        public Or<Audience>? PermitAudience { get; set; }

        /// The time validity of the permit.
        public Or<Duration>? ValidFor { get; set; }

        /// The date when the item becomes valid.
        public Or<DateTime>? ValidFrom { get; set; }

        /// The geographic area where the permit is valid.
        public Or<AdministrativeArea>? ValidIn { get; set; }

        /// The date when the item is no longer valid.
        public Or<SuperStructs.Date>? ValidUntil { get; set; }
