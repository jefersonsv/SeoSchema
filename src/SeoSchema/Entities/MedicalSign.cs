...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MedicalSign"/>
    /// </summary>
    public class MedicalSign : IEntity
    {
        /// A physical examination that can identify this sign.
        public Or<PhysicalExam>? IdentifyingExam { get; set; }

        /// A diagnostic test that can identify this sign.
        public Or<MedicalTest>? IdentifyingTest { get; set; }
