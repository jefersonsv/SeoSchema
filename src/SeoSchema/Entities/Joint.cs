...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/Joint"/>
    /// </summary>
    public class Joint : IEntity
    {
        /// The biomechanical properties of the bone.
        public Or<string>? BiomechnicalClass { get; set; }

        /// The degree of mobility the joint allows.
        public Or<MedicalEntity, string>? FunctionalClass { get; set; }

        /// The name given to how bone physically connects to each other.
        public Or<string>? StructuralClass { get; set; }
