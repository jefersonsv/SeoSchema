...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/SoftwareSourceCode"/>
    /// </summary>
    public class SoftwareSourceCode : IEntity
    {
        /// Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
        public Or<Uri>? CodeRepository { get; set; }

        /// What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template. Supersedes sampleType.
        public Or<string>? CodeSampleType { get; set; }

        /// The computer programming language.
        public Or<ComputerLanguage, string>? ProgrammingLanguage { get; set; }

        /// Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0). Supersedes runtime.
        public Or<string>? RuntimePlatform { get; set; }

        /// Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
        public Or<SoftwareApplication>? TargetProduct { get; set; }
