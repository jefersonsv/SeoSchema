...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/ExerciseAction"/>
    /// </summary>
    public class ExerciseAction : IEntity
    {
        /// A sub property of instrument. The diet used in this action.
        public Or<Diet>? Diet { get; set; }

        /// The distance travelled, e.g. exercising or travelling.
        public Or<Distance>? Distance { get; set; }

        /// A sub property of location. The course where this action was taken. Supersedes course.
        public Or<Place>? ExerciseCourse { get; set; }

        /// A sub property of instrument. The exercise plan used on this action.
        public Or<ExercisePlan>? ExercisePlan { get; set; }

        /// A sub property of instrument. The diet used in this action.
        public Or<Diet>? ExerciseRelatedDiet { get; set; }
        ...
        public Or<Person>? Opponent { get; set; }

        /// A sub property of location. The sports activity location where this action occurred.
        public Or<SportsActivityLocation>? SportsActivityLocation { get; set; }

        /// A sub property of location. The sports event where this action occurred.
        public Or<SportsEvent>? SportsEvent { get; set; }

        /// A sub property of participant. The sports team that participated on this action.
        public Or<SportsTeam>? SportsTeam { get; set; }
