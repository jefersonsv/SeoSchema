...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/Recipe"/>
    /// </summary>
    public class Recipe : IEntity
    {
        /// The time it takes to actually cook the dish, in ISO 8601 duration format.
        public Or<Duration>? CookTime { get; set; }

        /// The method of cooking, such as Frying, Steaming, ...
        public Or<string>? CookingMethod { get; set; }

        /// Nutrition information about the recipe or menu item.
        public Or<NutritionInformation>? Nutrition { get; set; }

        /// The category of the recipe—for example, appetizer, entree, etc.
        public Or<string>? RecipeCategory { get; set; }

        /// The cuisine of the recipe (for example, French or Ethiopian).
        public Or<string>? RecipeCuisine { get; set; }

        /// A single ingredient used in the recipe, e.g. sugar, flour or garlic. Supersedes ingredients.
        public Or<string>? RecipeIngredient { get; set; }

        /// A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
        public Or<CreativeWork, ItemList, string>? RecipeInstructions { get; set; }

        /// The quantity produced by the recipe (for example, number of people served, number of servings, etc).
        public Or<QuantitativeValue, string>? RecipeYield { get; set; }

        /// Indicates a dietary restriction or guideline for which this recipe or menu item is suitable, e.g. diabetic, halal etc.
        public Or<RestrictedDiet>? SuitableForDiet { get; set; }

        /// The estimated cost of the supply or supplies consumed when performing instructions.
        public Or<MonetaryAmount, string>? EstimatedCost { get; set; }
        ...
        public Or<Duration>? TotalTime { get; set; }

        /// The quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles.
        public Or<QuantitativeValue, string>? Yield { get; set; }
