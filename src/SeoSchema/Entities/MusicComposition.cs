...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MusicComposition"/>
    /// </summary>
    public class MusicComposition : IEntity
    {
        /// The person or organization who wrote a composition, or who is the composer of a work performed at some event.
        public Or<Organization, Person>? Composer { get; set; }

        /// The date and place the work was first performed.
        public Or<Event>? FirstPerformance { get; set; }

        /// Smaller compositions included in this work (e.g. a movement in a symphony).
        public Or<MusicComposition>? IncludedComposition { get; set; }

        /// The International Standard Musical Work Code for the composition.
        public Or<string>? IswcCode { get; set; }

        /// The person who wrote the words.
        public Or<Person>? Lyricist { get; set; }

        /// The words in the song.
        public Or<CreativeWork>? Lyrics { get; set; }

        /// An arrangement derived from the composition.
        public Or<MusicComposition>? MusicArrangement { get; set; }

        /// The type of composition (e.g. overture, sonata, symphony, etc.).
        public Or<string>? MusicCompositionForm { get; set; }

        /// The key, mode, or scale this composition uses.
        public Or<string>? MusicalKey { get; set; }

        /// An audio recording of the work. Inverse property: recordingOf.
        public Or<MusicRecording>? RecordedAs { get; set; }
