...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/APIReference"/>
    /// </summary>
    public class APIReference : IEntity
    {
        /// Associated product/technology version. e.g., .NET Framework 4.5.
        public Or<string>? AssemblyVersion { get; set; }

        /// Library file name e.g., mscorlib.dll, system.web.dll. Supersedes assembly.
        public Or<string>? ExecutableLibraryName { get; set; }

        /// Indicates whether API is managed or unmanaged.
        public Or<string>? ProgrammingModel { get; set; }

        /// Type of app development: phone, Metro style, desktop, XBox, etc.
        public Or<string>? TargetPlatform { get; set; }

        /// Prerequisites needed to fulfill steps in article.
        public Or<string>? Dependencies { get; set; }

        /// Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
        public Or<string>? ProficiencyLevel { get; set; }
