...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MusicRecording"/>
    /// </summary>
    public class MusicRecording : IEntity
    {
        ...
        public Or<MusicAlbum>? InAlbum { get; set; }

        /// The playlist to which this recording belongs.
        public Or<MusicPlaylist>? InPlaylist { get; set; }

        /// The International Standard Recording Code for the recording.
        public Or<string>? IsrcCode { get; set; }

        /// The composition this track is a recording of. Inverse property: recordedAs.
        public Or<MusicComposition>? RecordingOf { get; set; }
