...
namespace SeoSchema.Entities
{
    /// <summary>
    /// A video file.
    /// <see cref="https://schema.org/VideoObject"/>
    /// </summary>
    public class VideoObject : IEntity
    {
        ...
        public Or<string>? Caption { get; set; }
        ...
        public Or<ImageObject>? Thumbnail { get; set; }

        /// If this MediaObject is an AudioObject or VideoObject, the transcript of that object.
        public Or<string>? Transcript { get; set; }

        /// The frame size of the video.
        public Or<string>? VideoFrameSize { get; set; }

        /// The quality of the video.
        public Or<string>? VideoQuality { get; set; }
