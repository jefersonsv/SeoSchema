...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/CategoryCodeSet"/>
    /// </summary>
    public class CategoryCodeSet : IEntity
    {
        /// A Category code contained in this code set.
        public Or<CategoryCode>? HasCategoryCode { get; set; }

        /// A Defined Term contained in this term set.
        public Or<DefinedTerm>? HasDefinedTerm { get; set; }
