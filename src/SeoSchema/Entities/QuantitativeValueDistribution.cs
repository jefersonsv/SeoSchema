...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/QuantitativeValueDistribution"/>
    /// </summary>
    public class QuantitativeValueDistribution : IEntity
    {
        /// The duration of the item (movie, audio recording, event, etc.) in ISO 8601 date format.
        public Or<Duration>? Duration { get; set; }

        /// The median value.
        public Or<double>? Median { get; set; }

        /// The 10th percentile value.
        public Or<double>? Percentile10 { get; set; }

        /// The 25th percentile value.
        public Or<double>? Percentile25 { get; set; }

        /// The 75th percentile value.
        public Or<double>? Percentile75 { get; set; }

        /// The 90th percentile value.
        public Or<double>? Percentile90 { get; set; }
