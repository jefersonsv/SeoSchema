...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/ReplaceAction"/>
    /// </summary>
    public class ReplaceAction : IEntity
    {
        /// A sub property of object. The object that is being replaced.
        public Or<Thing>? Replacee { get; set; }

        /// A sub property of object. The object that replaces.
        public Or<Thing>? Replacer { get; set; }

        /// A sub property of object. The collection target of the action. Supersedes collection.
        public Or<Thing>? TargetCollection { get; set; }
