...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/BusinessAudience"/>
    /// </summary>
    public class BusinessAudience : IEntity
    {
        /// The number of employees in an organization e.g. business.
        public Or<QuantitativeValue>? NumberOfEmployees { get; set; }

        /// The size of the business in annual revenue.
        public Or<QuantitativeValue>? YearlyRevenue { get; set; }

        /// The age of the business.
        public Or<QuantitativeValue>? YearsInOperation { get; set; }
