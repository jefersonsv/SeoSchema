...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/MusicRelease"/>
    /// </summary>
    public class MusicRelease : IEntity
    {
        /// The catalog number for the release.
        public Or<string>? CatalogNumber { get; set; }

        /// The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
        public Or<Organization, Person>? CreditedTo { get; set; }

        /// The duration of the item (movie, audio recording, event, etc.) in ISO 8601 date format.
        public Or<Duration>? Duration { get; set; }

        /// Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).
        public Or<MusicReleaseFormatType>? MusicReleaseFormat { get; set; }

        /// The label that issued the release.
        public Or<Organization>? RecordLabel { get; set; }

        /// The album this is a release of. Inverse property: albumRelease.
        public Or<MusicAlbum>? ReleaseOf { get; set; }

        /// The number of tracks in this album or playlist.
        public Or<int>? NumTracks { get; set; }
        ...
        public Or<ItemList, MusicRecording>? Track { get; set; }
