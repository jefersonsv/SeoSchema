...
namespace SeoSchema.Entities
{
    ...
    public class TVEpisode : IEntity
    {
        ...
        public Or<int, string>? EpisodeNumber { get; set; }

        /// The composer of the soundtrack.
        public Or<MusicGroup, Person>? MusicBy { get; set; }

        /// The season to which this episode belongs.
        public Or<CreativeWorkSeason>? PartOfSeason { get; set; }

        /// The series to which this episode or season belongs. Supersedes partOfTVSeries.
        public Or<CreativeWorkSeries>? PartOfSeries { get; set; }
