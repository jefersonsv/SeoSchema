...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/SearchResultsPage"/>
    /// </summary>
    public class SearchResultsPage : IEntity
    {
        /// A set of links that can help a user understand and navigate a website hierarchy.
        public Or<BreadcrumbList, string>? Breadcrumb { get; set; }

        /// Date on which the content on this web page was last reviewed for accuracy and/or completeness.
        public Or<SuperStructs.Date>? LastReviewed { get; set; }

        /// Indicates if this web page element is the main subject of the page. Supersedes aspect.
        public Or<WebPageElement>? MainContentOfPage { get; set; }

        /// Indicates the main image on the page.
        public Or<ImageObject>? PrimaryImageOfPage { get; set; }

        /// A link related to this web page, for example to other related web pages.
        public Or<Uri>? RelatedLink { get; set; }

        /// People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
        public Or<Organization, Person>? ReviewedBy { get; set; }
        ...
        public Or<Uri>? SignificantLink { get; set; }
        ...
        public Or<Specialty>? Specialty { get; set; }
