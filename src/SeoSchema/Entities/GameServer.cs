...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/GameServer"/>
    /// </summary>
    public class GameServer : IEntity
    {
        /// Video game which is played on this server. Inverse property: gameServer.
        public Or<VideoGame>? Game { get; set; }

        /// Number of players on the server.
        public Or<int>? PlayersOnline { get; set; }

        /// Status of a game server.
        public Or<GameServerStatus>? ServerStatus { get; set; }
