...
namespace SeoSchema.Entities
{
    /// <summary>
    /// A doctor's office.
    /// <see cref="https://schema.org/Physician"/>
    /// </summary>
    public class Physician : IEntity
    {
        /// A medical service available from this provider.
        public Or<MedicalProcedure, MedicalTest, MedicalTherapy>? AvailableService { get; set; }

        /// A hospital with which the physician or office is affiliated.
        public Or<Hospital>? HospitalAffiliation { get; set; }

        /// A medical specialty of the provider.
        public Or<MedicalSpecialty>? MedicalSpecialty { get; set; }
        ...
        public Or<string>? HealthPlanNetworkId { get; set; }

        /// Whether the provider is accepting new patients.
        public Or<bool>? IsAcceptingNewPatients { get; set; }
