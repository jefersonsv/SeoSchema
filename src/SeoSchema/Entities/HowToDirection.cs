...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/HowToDirection"/>
    /// </summary>
    public class HowToDirection : IEntity
    {
        /// A media object representing the circumstances after performing this direction.
        public Or<MediaObject, Uri>? AfterMedia { get; set; }

        /// A media object representing the circumstances before performing this direction.
        public Or<MediaObject, Uri>? BeforeMedia { get; set; }

        /// A media object representing the circumstances while performing this direction.
        public Or<MediaObject, Uri>? DuringMedia { get; set; }
        ...
        public Or<ListItem>? NextItem { get; set; }

        /// A link to the ListItem that preceeds the current one.
        public Or<ListItem>? PreviousItem { get; set; }
