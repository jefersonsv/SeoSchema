...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/Nerve"/>
    /// </summary>
    public class Nerve : IEntity
    {
        /// The neurological pathway extension that involves muscle control.
        public Or<Muscle>? NerveMotor { get; set; }

        /// The neurological pathway extension that inputs and sends information to the brain or spinal cord.
        public Or<AnatomicalStructure, SuperficialAnatomy>? SensoryUnit { get; set; }

        /// The neurological pathway that originates the neurons.
        public Or<BrainStructure>? SourcedFrom { get; set; }
