...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/CompoundPriceSpecification"/>
    /// </summary>
    public class CompoundPriceSpecification : IEntity
    {
        /// This property links to all UnitPriceSpecification nodes that apply in parallel for the CompoundPriceSpecification node.
        public Or<UnitPriceSpecification>? PriceComponent { get; set; }
