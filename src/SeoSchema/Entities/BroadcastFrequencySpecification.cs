...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/BroadcastFrequencySpecification"/>
    /// </summary>
    public class BroadcastFrequencySpecification : IEntity
    {
        /// The frequency in MHz for a particular broadcast.
        public Or<double, QuantitativeValue>? BroadcastFrequencyValue { get; set; }
