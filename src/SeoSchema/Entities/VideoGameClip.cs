...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/VideoGameClip"/>
    /// </summary>
    public class VideoGameClip : IEntity
    {
        ...
        public Or<int, string>? ClipNumber { get; set; }
        ...
        public Or<Episode>? PartOfEpisode { get; set; }
