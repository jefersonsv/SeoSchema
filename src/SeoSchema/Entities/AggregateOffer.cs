...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/AggregateOffer"/>
    /// </summary>
    public class AggregateOffer : IEntity
    {
        /// The highest price of all offers available.
        public Or<double, string>? HighPrice { get; set; }

        /// The lowest price of all offers available.
        public Or<double, string>? LowPrice { get; set; }

        /// The number of offers for the product.
        public Or<int>? OfferCount { get; set; }
        ...
        public Or<SuperStructs.Date>? PriceValidUntil { get; set; }
