...
namespace SeoSchema.Entities
{
    ...
    /// <see cref="https://schema.org/TrainTrip"/>
    /// </summary>
    public class TrainTrip : IEntity
    {
        /// The platform where the train arrives.
        public Or<string>? ArrivalPlatform { get; set; }

        /// The station where the train trip ends.
        public Or<TrainStation>? ArrivalStation { get; set; }

        /// The platform from which the train departs.
        public Or<string>? DeparturePlatform { get; set; }

        /// The station from which the train departs.
        public Or<TrainStation>? DepartureStation { get; set; }

        /// The name of the train (e.g. The Orient Express).
        public Or<string>? TrainName { get; set; }

        /// The unique identifier for the train.
        public Or<string>? TrainNumber { get; set; }
